...
PGPMPIdentifier const PGPMPIdentifierQ = @"Q";
PGPMPIdentifier const PGPMPIdentifierD = @"D";
...
PGPMPIdentifier const PGPMPIdentifierEC_V = @"EC_V"; // EC point. Ephemeral public key
